...
font_path = 'C:/Users/customer/OneDrive/pmsimages/custom_font.ttf'  # 사용자 정의 폰트 경로
font_size = 55
...
# 이미지 로드 및 크기 조정
chicken_frames = [
    pygame.transform.scale(pygame.image.load('C:/Users/customer/OneDrive/pmsimages/chicken_frame1.png'), (50, 50)),
    pygame.transform.scale(pygame.image.load('C:/Users/customer/OneDrive/pmsimages/chicken_frame2.png'), (50, 50)),
    pygame.transform.scale(pygame.image.load('C:/Users/customer/OneDrive/pmsimages/chicken_frame3.png'), (50, 50)),
    pygame.transform.scale(pygame.image.load('C:/Users/customer/OneDrive/pmsimages/chicken_frame4.png'), (50, 50))
]
...
# 기타 이미지 로드 및 크기 조정
chicken_hit_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/chicken_hit.png')
chicken_hit_img = pygame.transform.scale(chicken_hit_img, (50, 50))

armor_chicken_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/armor_chicken.png')
armor_chicken_img = pygame.transform.scale(armor_chicken_img, (50, 50))

knife_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/knife.png')
knife_img = pygame.transform.scale(knife_img, (50, 50))

fire_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/fire.png')
fire_img = pygame.transform.scale(fire_img, (50, 50))

car_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/car.png')
car_img = pygame.transform.scale(car_img, (50, 50))

motorbike_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/motorbike.png')
motorbike_img = pygame.transform.scale(motorbike_img, (50, 50))

truck_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/truck.png')
truck_img = pygame.transform.scale(truck_img, (50, 50))

fox_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/fox.png')
fox_img = pygame.transform.scale(fox_img, (50, 50))

snake_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/snake.png')
snake_img = pygame.transform.scale(snake_img, (50, 50))

tiger_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/tiger.png')
tiger_img = pygame.transform.scale(tiger_img, (50, 50))

bg_start = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/start_screen.png')
bg_start = pygame.transform.scale(bg_start, (screen_width, screen_height))

bg_instructions = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/instructions.png')  # 설명 이미지 로드
bg_instructions = pygame.transform.scale(bg_instructions, (screen_width, screen_height))

bg_stage1 = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/background1.png')
bg_stage1 = pygame.transform.scale(bg_stage1, (screen_width, screen_height))
bg_stage2 = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/background2.png')
bg_stage2 = pygame.transform.scale(bg_stage2, (screen_width, screen_height))
bg_stage3 = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/background3.png')
bg_stage3 = pygame.transform.scale(bg_stage3, (screen_width, screen_height))
final_scene = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/nature.png')
final_scene = pygame.transform.scale(final_scene, (screen_width, screen_height))

armor_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/armor.png')
armor_img = pygame.transform.scale(armor_img, (50, 50))

gameover_img = pygame.image.load('C:/Users/customer/OneDrive/pmsimages/gameover_screen.png')
...
def initialize_game(stage):
    ...
    # 장애물 생성
    knife_obstacles = create_obstacle(knife_img, 4)
    fire_obstacles = create_obstacle(fire_img, 4)
    ...
    tiger_obstacles = create_obstacle(tiger_img, 3)
    ...
    if current_stage == 1:
        ...
        obstacle_speed = 1.05  # 2단계 초기 속도
    elif current_stage == 3:
        obstacle_speed = 1.10  # 3단계 초기 속도
